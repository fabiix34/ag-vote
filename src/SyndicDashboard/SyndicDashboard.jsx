        ...
        {loading ? (
          ...
          <div className="text-center py-20 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-2xl">
            ...
            <p className="text-zinc-400 text-sm mt-1">
              Créez votre première copropriété pour commencer
            </p>
          </div>
        ) : (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      {cp.adresse && (
                        <p className="text-zinc-500 text-sm">{cp.adresse}</p>
                      )}
                  ...
                  <ArrowRight
                    size={18}
                    className="text-zinc-400 group-hover:text-emerald-500 transition-colors flex-shrink-0"
                  />
                </button>
              );
            })}
