...
// Les votes sont gérés et mis à jour en temps réel par le parent (AdminView).
// Ce composant est purement présentationnel — aucun état local, aucune subscription.
export function ResultatsResolution({ resolution, votes, coproprietaires = [] }) {
